        ...
        <div class="news__excerpt">
            <div class="--row --fill --flex">
              <div class="--row">
                ...
                <p><b><span class="t2 --m2" v-html="post.date.substring(0,10)" /></b></p>
...
export default {
  ...
  methods: {
    ...
    getPosts () {
      axios
        .get(process.env.baseUrl + 'posts?per_page=100&categories=4&after=2015-12-31T00:00:00&before=2016-01-31T00:00:00')
        .then((response) => {
